...
setup(
    name = 'DreamStorm',
    packages = ['DreamStorm'], # this must be the same as the name above
    version = '0.1',
    ...
    download_url = 'https://github.com/OAlienO/DreamStorm/archive/0.1.tar.gz', # I'll explain this in a second

...
setup(
    name = 'DreamStorm',
    packages = ['DreamStorm','DreamStorm.lib'], # this must be the same as the name above
    version = '0.2',
    ...
    download_url = 'https://github.com/OAlienO/DreamStorm/archive/0.2.tar.gz', # I'll explain this in a second
